    ...
    <div className="flex flex-col items-center p-4 md:p-6 rounded-lg">
      {videoData ? (
        <div className="w-full">
          <video className="w-full rounded-lg shadow-md" src={videoCDNUrl} controls />
          ...
          <div className="text-white mt-2">
            {isExpanded ? (
              <React.Fragment>
                ...
                <button onClick={toggleExpand} className="bg-red-600 hover:bg-red-700 text-white font-bold py-1 px-4 rounded mt-3">Collapse</button>
              </React.Fragment>
            ) : (
              <React.Fragment>
