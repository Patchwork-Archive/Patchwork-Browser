    ...
    const ColumnVideoGrid = ({ apiUrl, titleText}) => {
        ...
        return (
            <div className="p-2 md:p-4">
                ...
                <div className="-m-2">
                    {videos.map((video) => (
                        <div key={video.id} className="video-row p-2 flex flex-col lg:flex-row hover:bg-gray-800 transition-all duration-300 ease-in-out hover:shadow-lg transform hover:-translate-y-1">
